...
References: `features/chedd-config/01-refdata-transform.md` (transform), `features/chedd-config/journey-config-pipelines-summary.md` (pipeline), `features/chedd-config/chedd-products-staging-audit.md` (the audited staging artifact), `features/notification-shape/04-migrate-chedd-products.md` (notification mapping).
