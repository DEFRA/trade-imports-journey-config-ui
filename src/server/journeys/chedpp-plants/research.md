...
- **Apples** (`0808108090`, in the Fruit and nuts group) ship with two species rows: `MABSD` (_Malus domestica_, the cultivated apple, with 67 recorded varieties including Braeburn, Cox, Gala, Pink Lady), and `MABSS` (other _Malus_ species, with two varieties).
